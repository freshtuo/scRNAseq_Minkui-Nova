...
#install all the packages when it asks
...
workdir <- file.path(basedir, "DropSeq_MJ_171005", sep="\\")
...
colorfile.fromPaper <- file.path(infodir, "cell.colors.txt", sep="\\")
orderfile.fromPaper <- file.path(infodir, "cell.plotting.order.txt", sep="\\")
...
write.table(cell.info.merged, file=file.path(infodir,"cell.filtered.annotations.SPRING.txt"), quote=FALSE, na="", sep="\t", col.names=NA)
...
# g <- g + theme_classic()
# ggsave(file.path(figdir,"exp.PRMT1.before_magic.png",sep="\\"), width=8, height=6, dpi=300)
# # after
# g <- ggplot(counts.magic.PRMT1) + geom_point(aes(x=VIM, y=GAPDH, color=PRMT1))
# g <- g + scale_color_viridis_c(option="B")
# g <- g + theme_classic()
# ggsave(file.path(figdir,"exp.PRMT1.after_magic.png",sep="\\"), width=8, height=6, dpi=300)
# # on DUSP4 gene
...
# g <- g + scale_color_viridis_c(option="B")
# g <- g + theme_classic()
# ggsave(file.path(figdir,"exp.DUSP4.before_magic.png",sep="\\"), width=8, height=6, dpi=300)
# # after
# g <- ggplot(counts.magic.DUSP4) + geom_point(aes(x=VIM, y=GAPDH, color=DUSP4))
# g <- g + scale_color_viridis_c(option="B")
# g <- g + theme_classic()
# ggsave(file.path(figdir,"exp.DUSP4.after_magic.png",sep="\\"), width=8, height=6, dpi=300)
# 
# # all_genes
...
#???
singlertest <- classifySingleR(test=counts.forSingleR, annot=singler.cellann.file,
                               project.name=project, min.genes=0,
                               technology="10X", species="Human", citation="",
                               ref.list=list(), normalize.gene.length=F, variable.genes="de",
                               fine.tune=F, do.main.types=T, reduce.file.size=F,
...
png(filename=paste(figdir,"singler.heatmap.HPCA.main_cell_type.png"), width=10, height=8, units="in", res=300)
...
save(matt, file=file.path(infodir, "matt.celltype.Robj"))
...
# 4678   9
write.table(spring.n.celltype, file=file.path("Spring", "info.table.celltype.txt"), quote=FALSE, na="", sep="\t", col.names=NA)
...
ggsave(file.path(SpringPlots, "SPRING.Plot.by_cell_type.png"), width=11, height=8, dpi=300)
g <- g + facet_wrap(~CellType, ncol=3)
ggsave(file.path(SpringPlots, "SPRING.Plot.by_cell_type.separated.png"), width=22, height=16, dpi=300)
...
g <- g + geom_jitter(shape=16, position=position_jitter(0.2), alpha=0.3)
g <- g + stat_summary(fun.data=median_hilow, geom="pointrange", color="gray75")
ggsave(file.path(figdir, "Violin.celltype.scores.png"), width=8, height=6, dpi=600)
...
g <- g + geom_point(shape=19, size=2, alpha=0.6)
g <- g + theme_classic()
ggsave(file.path(SpringPlots, "SPRING.top.ba.cells.png"), width=10, height=8, dpi=600)
#--------------------------------------------------------------------------------------------------------------------#
...
ggsave(file.path(figdir, "SPRING.cell.types.manual.by.markers.png", sep="\\"), width=10, height=8, dpi=600)
g <- g + facet_wrap(~cohort, ncol=3)
ggsave(file.path(figdir, "SPRING.cell.types.manual.by.markers.separated.png", sep="\\"), width=15, height=8, dpi=600)
...
ggsave(file.path(figdir, "SPRING.cell.types.manual.by.markers.v2.png", sep="\\"), width=10, height=8, dpi=600)
ggsave(file.path(figdir, "SPRING.cell.types.manual.by.markers.v2.svg", sep="\\"), width=10, height=8)
g <- g + facet_wrap(~orig.ident, ncol=2)
ggsave(file.path(figdir, "SPRING.cell.types.manual.by.markers.v2.split.png", sep="\\"), width=10, height=8, dpi=600)
ggsave(file.path(figdir, "SPRING.cell.types.manual.by.markers.v2.split.svg", sep="\\"), width=10, height=8)
...
g <- g + theme(legend.title=element_blank(), legend.text=element_text(size=18))
ggsave(file.path(figdir, "SPRING.exp_PRMT1.v2.png", sep="\\"), width=10, height=8, dpi=600)
ggsave(file.path(figdir, "SPRING.exp_PRMT1.v2.svg", sep="\\"), width=10, height=8)
g <- g + facet_wrap(~orig.ident, ncol=2)
ggsave(file.path(figdir, "SPRING.exp_PRMT1.v2.split.png", sep="\\"), width=10, height=8, dpi=600)
ggsave(file.path(figdir, "SPRING.exp_PRMT1.v2.split.svg", sep="\\"), width=10, height=8)
...
for(tgene in c('ITGA2B','GP1BA','PF4','IFNAR1')){
  ...
  g <- g + scale_color_gradient(low="lightgray", high="red4")
  g <- g + theme(legend.title=element_blank(), legend.text=element_text(size=18))
  ggsave(file.path(SpringPlots, paste("SPRING.exp_",tgene,"v2.png",sep='.'), sep="\\"), width=10, height=8, dpi=600)
  ggsave(file.path(SpringPlots, paste("SPRING.exp_",tgene,"v2.svg",sep='.'), sep="\\"), width=10, height=8)
  g <- g + facet_wrap(~orig.ident, ncol=2)
  ggsave(file.path(SpringPlots, paste("SPRING.exp_",tgene,"v2.split.png",sep='.'), sep="\\"), width=10, height=8, dpi=600)
  ggsave(file.path(SpringPlots, paste("SPRING.exp_",tgene,"v2.split.svg",sep='.'), sep="\\"), width=10, height=8)
}
...
g <- g + theme_classic()
g <- g + scale_color_manual(values=my.cols.v2)
ggsave(file.path(SpringPlots, "SPRING.cell.types.manual.by.n-1.markers.png", sep="\\"), width=10, height=8, dpi=600)
g <- g + facet_wrap(~cohort, ncol=3)
ggsave(file.path(SpringPlots, "SPRING.cell.types.manual.by.n-1.markers.separated.png", sep="\\"), width=15, height=8, dpi=600)
#--------------------------------------------------------------------------------------------------------------------#
...
ggsave(file.path(SpringPlots, "SPRING.cell.types.manual.by.markers.v3.png", sep="\\"), width=10, height=8, dpi=600)
g <- g + facet_wrap(~cohort, ncol=3)
ggsave(file.path(SpringPlots, "SPRING.cell.types.manual.by.markers.v3.separated.png", sep="\\"), width=15, height=8, dpi=600)
#--------------------------------------------------------------------------------------------------------------------#
...
g <- g + geom_vline(xintercept=1000, color="red")
g <- g + theme_classic()
ggsave(file.path(figdir, "histogram.nCount_RNA.per.cell.D8_CD42bCD41.png", sep="\\"), width=8, height=6, dpi=300)
...
g <- g + scale_color_viridis_c(option="B")
g <- g + theme_classic()
ggsave(file.path(figdir,"exp.PRMT1.before_magic.D8_CD42bCD41.png"), width=8, height=6, dpi=300)
# after
g <- ggplot(tcounts.magic) + geom_point(aes(x=VIM, y=GAPDH, color=PRMT1))
g <- g + scale_color_viridis_c(option="B")
g <- g + theme_classic()
ggsave(file.path(figdir,"exp.PRMT1.after_magic.D8_CD42bCD41.png"), width=8, height=6, dpi=300)
...
dim(texp.magic)
# 10656  1077
write.table(texp.magic, file=gzfile(file.path(infodir,"exp.sqrt.after_magic.D8_CD42bCD41.tsv.gz")), quote=FALSE, na="", sep="\t", col.names=NA)
###write.table(t(as.matrix((counts.magic.all$result)^2)), file=gzfile(paste(infodir,"exp.pseudo_counts.after_magic.tsv.gz",sep="/")), quote=FALSE, na="", sep="\t", col.names=NA)
...
write.table(data.frame(PRMT1 = sort(scc["PRMT1",], decreasing=T)), file=file.path(infodir, "spearman.correlation.D8_CD42bCD41.after_magic.PRMT1.txt"), quote=FALSE, na="", sep="\t", col.names=F, row.names=T)
...
# 17880 17880
# rank genes by their correlation with PRMT1
write.table(data.frame(PRMT1 = sort(scc.raw["PRMT1",], decreasing=T)), file=file.path(infodir, "spearman.correlation.D8_CD42bCD41.before_magic.PRMT1.txt"), quote=FALSE, na="", sep="\t", col.names=F, row.names=T)
...
for (cdt in c("D0_unstimulated", "D8_other", "D8_stimulated")){
  ...
  g <- g + scale_color_viridis_c(option="B")
  g <- g + theme_classic()
  ggsave(file.path(figdir,paste("exp","PRMT1","before_magic",cdt,"png",sep=".")), width=8, height=6, dpi=300)
  # after
  g <- ggplot(tcounts.magic) + geom_point(aes(x=VIM, y=GAPDH, color=PRMT1))
  g <- g + scale_color_viridis_c(option="B")
  g <- g + theme_classic()
  ggsave(file.path(figdir,paste("exp","PRMT1","after_magic",cdt,"png",sep=".")), width=8, height=6, dpi=300)
  ...
  # 10656  1077
  write.table(texp.magic, file=gzfile(file.path(infodir,paste("exp","sqrt","after_magic",cdt,"tsv","gz",sep="."))), quote=FALSE, na="", sep="\t", col.names=NA)
  ###write.table(t(as.matrix((counts.magic.all$result)^2)), file=gzfile(paste(infodir,"exp.pseudo_counts.after_magic.tsv.gz",sep="/")), quote=FALSE, na="", sep="\t", col.names=NA)
...
g <- g + theme(axis.title=element_blank(), axis.text=element_blank(), axis.line=element_blank(), axis.ticks=element_blank())
ggsave(file.path(SpringPlots,"SPRING.Plot.use_paper_codes.ggplot.png"), width=10, height=8, dpi=600)
ggsave(file.path(SpringPlots,"SPRING.Plot.use_paper_codes.ggplot.svg"), width=10, height=8)
...
g <- g + theme(legend.position="none")
g <- g + theme(axis.title=element_blank(), axis.text=element_blank(), axis.line=element_blank(), axis.ticks=element_blank())
ggsave(file.path(SpringPlots,"SPRING.Plot.use_paper_codes.ggplot.separated.png"), width=20, height=16, dpi=600)
ggsave(file.path(SpringPlots,"SPRING.Plot.use_paper_codes.ggplot.separated.svg"), width=20, height=16)
